<?php include('includes/header.php');?>
   ...
   <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Other Year's Members
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li>Members</li>
        <li class="active">Other Years</li>
      </ol>
    </section>
    <!-- Main content -->
                    ...
                    try{
                      $sql = 'SELECT 
                              ...
                              FROM 
                                  members 
                              LEFT JOIN
                                  profile p ON members.id=p.member_id WHERE year_of_study=" "';                       
...
function getRow(id){
  $.ajax({
    ...
    success: function(response){
      ...
      $('.fullname').html(response.Othername+' '+response.lastname);
    }
  });
}
</script>
