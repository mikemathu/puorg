<?php include('includes/header.php');?>
   ...
   <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Fourth Year's Members
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li>Members</li>
        <li class="active">Fourth Years</li>
      </ol>
    </section>
    <!-- Main content -->
                    ...
                    try{
                      $sql = 'SELECT 
                              ...
                              FROM 
                                  members 
                              LEFT JOIN
                                  profile p ON members.id=p.member_id WHERE year_of_study=4';                       
...
function getRow(id){
  $.ajax({
    ...
    success: function(response){
      ...
      $('#edit_Fourthname').val(response.Fourthname);
      $('#edit_lastname').val(response.lastname);
      $('#edit_address').val(response.address);
      $('#edit_contact').val(response.contact_info);
      $('.fullname').html(response.Fourthname+' '+response.lastname);
    }
  });
}
</script>
