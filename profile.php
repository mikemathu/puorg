...
// 	if(  !empty($row['photo']) ||   !empty($row['year_of_study']) || !empty($row['skills'])  ||  !empty($row['notes'])   ) {
	        						...
	        						<div class="col-sm-3">
	        							...
	        							<h4>Email:</h4>
											<?php	if(!empty($row['course'])){ ?>
													<h4>Course</h4>
<?php }?>
<?php	if(!empty($row['year_of_study'])){ ?>
	<h4>Year of study</h4>
<?php }?>
	        						...
	        						<div class="col-sm-9">
	        							<h4><?php echo $row['username']; ?>
	        								<span class="pull-right">
	        									<a href="#profile" class="btn btn-success btn-flat btn-sm" data-toggle="modal"  onclick='goDoSomething(this);'><i class="fa fa-edit"></i> Edit</a>
	        								</span>
	        							</h4>
